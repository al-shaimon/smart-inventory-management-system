    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5" style={{ borderBottom: '1px solid var(--border-color)' }}>
          <div className="flex items-center justify-center w-9 h-9 rounded-xl gradient-accent">
          ...
          <div>
            <h2 className="text-sm font-bold gradient-text">Smart Inventory</h2>
            <p className="text-xs" style={{ color: 'var(--muted-fg)' }}>Management System</p>
          </div>
